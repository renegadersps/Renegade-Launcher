...
cp native/build-aarch64/src/Release/Renegade.exe build/win-aarch64/
cp target/Renegade.jar build/win-aarch64/
...
echo Renegade.exe aarch64 sha256sum
sha256sum build/win-aarch64/Renegade.exe

dumpbin //HEADERS build/win-aarch64/Renegade.exe
