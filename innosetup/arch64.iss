...
OutputDir=${basedir}
OutputBaseFilename=RenegadeSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\Renegade.exe"; DestDir: "{app}"
Source: "${basedir}\build\win-aarch64\Renegade.jar"; DestDir: "{app}"
