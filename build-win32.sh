...
cp native/build-x86/src/Release/Renegade.exe build/win-x86/
cp target/Renegade.jar build/win-x86/
...
echo Renegade.exe 32bit sha256sum
sha256sum build/win-x86/Renegade.exe

dumpbin //HEADERS build/win-x86/Renegade.exe
